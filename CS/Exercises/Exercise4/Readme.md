...
# Opgave 3:
Maak commentaar van de regel `var elements = StreamXml(XmlFileName);`. Voeg nieuwe code toe die de data vanuit de zojuist aangemaakte json i.p.v. de xml inleest.

# Opgave 4 extra:
Kijk waar we veel geheugen gebruiken en hoe je dit kan optimaliseren door efficientere code. Denk hierbij aan `XStreamingElement`, flushes van de json writer en `JsonSerializer.DeserializeAsyncEnumerable`.